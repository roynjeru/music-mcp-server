namespace src 
{
    public static class Constants
    {
        ...
        public const string AddItemsToPlaylistDescription = "The one playlist id that the user wants to add items to.";

        public const string UrisDescription = "An array of the Spotify URIs to add. For example: ['spotify:track:4iV5W9uYEdYUVa79Axb7Rh','spotify:track:1301WleyT98MSxVHPZCA6M', 'spotify:episode:512ojhOuo1ktJprKbVcKyQ']";
    }
}
